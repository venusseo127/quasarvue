...
export interface Cookies {
     ...
     */
    parseSSR (ssrContext : LooseDictionary): LooseDictionary
}
...
export interface QField extends Vue {
    ...
    autofocus? : boolean
    /**
     * DOM element id to be used as 'for' attribute of the label and as 'id' for the focus target
     */
    for? : string
    /**
...
export interface QScrollArea extends Vue {
    ...
    horizontal? : boolean
    /**
     * Use custom scrollbar on mobile too; The scroll area will not benefit from inertial scrolling on mobile
     */
...
export interface QSelect extends Vue {
     ...
     * @param index The index of the list item to scroll to after refresh (0 based); If it's not specified the scroll position is not changed
     */
